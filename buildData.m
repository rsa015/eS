...
std_room.addEquipments(ac, 1, 1190, "0600-1000;1400-1800;2000-2400;0000-0200");
std_room.addEquipments(phone, 2, 5, "3");
std_room.addEquipments(tv, 1, 80, "0600-0800;2000-2300");
std_room.addEquipments(fan, 1, 50, "1400-1800;2000-2400");
std_room.addEquipments(fridge, 1, 85, "0000-2400");
...
two_broom.addEquipments(ac, 1, 1120, "0600-1000;1400-1800;2000-2400;0000-0200");
two_broom.addEquipments(phone, 2, 5, "3");
two_broom.addEquipments(tv, 1, 80, "0600-0800;2000-2300");
two_broom.addEquipments(fan, 1, 50, "1400-1800;2000-2400");
two_broom.addEquipments(fridge, 1, 85, "0000-2400");
...
three_broom.addEquipments(ac, 1, 1120, "0600-1000;1400-1800;2000-2400;0000-0200");
three_broom.addEquipments(phone, 2, 5, "3");
three_broom.addEquipments(tv, 1, 80, "0600-0800;2000-2300");
three_broom.addEquipments(fan, 1, 50, "1400-1800;2000-2400");
three_broom.addEquipments(fridge, 1, 85, "0000-2400");
...
kitchen.addEquipments(freezer, 8, 100, "0000-2400");
kitchen.addEquipments(phone, 2, 5, "3");
kitchen.addEquipments(fridge, 2, 150, "0000-2400");
kitchen.addEquipments(fan, 8, 50, "1400-1800;2000-2400");
...
kitchen.addEquipments(pool_heater, 1, 25, "0000-2400");
...
common_areas.addEquipments(light_bulb, 40, 20, "1800-2400;0000-0600");
...
reception.addEquipments(light_bulb, 6, 20, "1800-2400;0000-0600");
reception.addEquipments(tv, 1, 100, "0000-2400");
reception.addEquipments(computer, 2, 100, "0000-2400");
...
laundry.addEquipments(washer, 8, 250, "0000-2400");
